...
import com.example.lm.count_people.Adapter.VpAdapter;
...
public class GuideActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener {
    ...
    private static  int[] imgs = {R.drawable.y1,R.drawable.y2, R.drawable.y3};
            ...
            if (i == imgs.length -1 ){
                ...
                iv.setOnTouchListener(new View.OnTouchListener(){
                    ...
                    public boolean onTouch(View v, MotionEvent event){
                        //跳转到主界面
                        Intent toMainActivity = new Intent(GuideActivity.this, LoginActivity.class);
